    ...
    return (
        ...
        <div className='lg:bg-[#0F171E]  lg:w-[427px] lg:h-[153px] md:w-[300px] md:h-[100px] sm:w-[200] sm:h-[90] relative right-3 '>
            ...
            <div className="icons grid grid-cols-2 gap-0">
                <a className='github text-white' href={githubUrl} target="_blank" rel="noopener noreferrer">
                    <FaGithub className="lg:w-[42px] lg:h-[42px] md:w-[32px] md:h-[32px] sm:h-[24px] sm:w-[24px] relative bottom-1 lg:left-40 lg:ml-5 md:left-14 md:ml-16"/> 
                </a>
                <a className='linkedin text-white' href={linkedinUrl} target="_blank" rel="noopener noreferrer">
